...
{
    public static class GaussianSplatAssetProcessor
    {
        public const string CamerasJson = "cameras.json";
        ...
        public static void ApplyQualityLevel(DataQuality quality, ref ImportSettings settings)
        {
            switch (quality)
            {
                ...
                case DataQuality.VeryLow:
                    settings.FormatPos = GaussianSplatAsset.VectorFormat.Norm11;
                    settings.FormatScale = GaussianSplatAsset.VectorFormat.Norm6;
                    settings.FormatColor = GaussianSplatAsset.ColorFormat.BC7;
                    settings.FormatSH = GaussianSplatAsset.SHFormat.Cluster4k;
                    break;
                case DataQuality.Low:
                    settings.FormatPos = GaussianSplatAsset.VectorFormat.Norm11;
                    settings.FormatScale = GaussianSplatAsset.VectorFormat.Norm6;
                    settings.FormatColor = GaussianSplatAsset.ColorFormat.Norm8x4;
                    settings.FormatSH = GaussianSplatAsset.SHFormat.Cluster16k;
                    break;
                case DataQuality.Medium:
                    settings.FormatPos = GaussianSplatAsset.VectorFormat.Norm11;
                    settings.FormatScale = GaussianSplatAsset.VectorFormat.Norm11;
                    settings.FormatColor = GaussianSplatAsset.ColorFormat.Norm8x4;
                    settings.FormatSH = GaussianSplatAsset.SHFormat.Norm6;
                    break;
                case DataQuality.High:
                    settings.FormatPos = GaussianSplatAsset.VectorFormat.Norm16;
                    settings.FormatScale = GaussianSplatAsset.VectorFormat.Norm16;
                    settings.FormatColor = GaussianSplatAsset.ColorFormat.Float16x4;
                    settings.FormatSH = GaussianSplatAsset.SHFormat.Norm11;
                    break;
                case DataQuality.VeryHigh:
                    settings.FormatPos = GaussianSplatAsset.VectorFormat.Float32;
                    settings.FormatScale = GaussianSplatAsset.VectorFormat.Float32;
                    settings.FormatColor = GaussianSplatAsset.ColorFormat.Float32x4;
                    settings.FormatSH = GaussianSplatAsset.SHFormat.Float32;
                    break;
                default:
        ...
        public static unsafe void CalculateBounds(NativeArray<InputSplatData> splatData, out float3 boundsMin, out float3 boundsMax)
        {
            float3 localMin, localMax;
            var boundsJob = new CalcBoundsJob
            {
                m_BoundsMin = &localMin,
                m_BoundsMax = &localMax,
        ...
        public static unsafe void ClusterSHs(
            ...
            out NativeArray<int> shIndices)
        {
            ...
            KMeansClustering.Calculate(kShDim, shData, kBatchSize, passesOverData, val =>
            {
                EditorUtility.DisplayProgressBar(progressTitle, $"Cluster SHs ({val:P0})", 0.2f + val * 0.5f);
                return true;
            }, shMeans, shIndices);
            shData.Dispose();
        ...
        public static unsafe byte[] CreateChunkBytes(NativeArray<InputSplatData> splatData, ref Hash128 dataHash)
        {
        ...
        public static unsafe byte[] CreatePositionsBytes(NativeArray<InputSplatData> inputSplats, GaussianSplatAsset.VectorFormat formatPos, ref Hash128 dataHash)
        {
        ...
        public static unsafe byte[] CreateOtherBytes(
        ...
        public static unsafe byte[] CreateColorBytes(NativeArray<InputSplatData> inputSplats, GaussianSplatAsset.ColorFormat formatColor, ref Hash128 dataHash)
        {
        ...
        public static unsafe byte[] CreateSHBytes(
            NativeArray<InputSplatData> inputSplats,
            ...
            ref Hash128 dataHash)
        {
            ...
            dataHash.Append(data);
            byte[] shResult = new byte[dataLen];
            fixed (byte* ptr = shResult)
                UnsafeUtility.MemCpy(ptr, data.GetUnsafeReadOnlyPtr(), dataLen);
            data.Dispose();
            return shResult;
        }
